...
import * as test_import_pb from './test_import_pb.js';
goog.object.extend(proto, test_import_pb);
goog.exportSymbol('A.B.C.TestEnum', null, proto);
goog.exportSymbol('A.B.C.TestMessage', null, proto);
goog.exportSymbol('A.B.C.TestMessage.MyOneofCase', null, proto);
goog.exportSymbol('A.B.C.TestMessage.NestedMessage', null, proto);
/**
